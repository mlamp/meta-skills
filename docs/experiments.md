...
- E-06 · IN PROGRESS 2026-07-21 · Reviewer fixes + deletion-recall revalidation. Applies the E-01 queued fixes (absence pass in the judgment step, fixed cold-reader probe set, ME/MT and NTPD cues, static_checks file line numbers, adjudicate worksheet hardening), then one new deletion-heavy planted fixture reviewed 5× by each of two model families. Baseline to beat: E-01 recall 1.0 on insertion flaws, 0/4 on pure deletions (adj-20260721-aeea8221b2, -0beccec7a6, -b58423aa64). Moves: C01, C06, C11.
