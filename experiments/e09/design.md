...
Frozen before measured execution. This PR designs the experiment. It does not run it. Measured mode remains locked until this commit is contained in `origin/main` and both cold-reader profiles pass the current qualification suite.
